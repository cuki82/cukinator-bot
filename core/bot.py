...
# Importar handlers
from handlers.message_handler  import handle_message, handle_voice, handle_document, handle_photo, handle_vault_callback, cmd_setvault, cmd_tenant, cmd_usage, cmd_qr
