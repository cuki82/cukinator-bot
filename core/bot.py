...
# Importar handlers
from handlers.message_handler  import handle_message, handle_voice, handle_document, handle_photo, handle_vault_callback, cmd_setvault, cmd_tenant, cmd_usage, cmd_qr, cmd_sf, handle_sf_callback, cmd_broker, cmd_rma, handle_rma_callback, cmd_stats, cmd_version, cmd_top
